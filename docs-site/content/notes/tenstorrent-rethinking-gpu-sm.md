---
title: "Tenstorrent 做了什么减法？从 NVIDIA GPU SM 到 Tensix Dataflow Core"
description: "Tenstorrent 是否相当于把 CUDA Core / SM 中对 AI 冗余的部分砍掉，再保留矩阵计算所需的核心能力？"
outline: deep
...
<Badge type="tip" text="Tenstorrent Tensix" /> <Badge type="tip" text="NVIDIA GPU" /> <Badge type="info" text="比较研究" />
