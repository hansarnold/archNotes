...
![1.1 端到端路线](../assets/diagrams/nvidia-gpu-synchronization-01.svg)
...
![2.2 Event 是 task completion receipt](../assets/diagrams/nvidia-gpu-synchronization-02.svg)
...
![3.1 Placement 是 forward-progress 前提](../assets/diagrams/nvidia-gpu-synchronization-03.svg)
...
![4.2 Scoreboard 签发 register-readiness receipt](../assets/diagrams/nvidia-gpu-synchronization-04.svg)
...
![5.2 Rendezvous 就是 phase boundary 汇合](../assets/diagrams/nvidia-gpu-synchronization-05.svg)
...
![6.2 TMA 把提交者、搬运者和消费者分开](../assets/diagrams/nvidia-gpu-synchronization-06.svg)
...
![7.1 双缓冲是双向交接，不是两个 boolean](../assets/diagrams/nvidia-gpu-synchronization-07.svg)
...
![7.2 两级 pipeline 的重叠时序](../assets/diagrams/nvidia-gpu-synchronization-08.svg)
...
![8.1 Kernel retirement 是 task receipt 的来源](../assets/diagrams/nvidia-gpu-synchronization-09.svg)
...
![9.1 Remote handoff timeline](../assets/diagrams/nvidia-gpu-synchronization-10.svg)
...
![11.1 先找到 tile 停在哪次交接](../assets/diagrams/nvidia-gpu-synchronization-11.svg)
