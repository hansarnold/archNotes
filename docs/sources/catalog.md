---
title: "AI Accelerator Architecture 资料目录"
description: "NVIDIA GPU、Groq TSP、Tenstorrent Tensix 与 Google TPU 的官方资料、论文、开源项目和统一证据边界。"
outline: deep
products: ["跨架构"]
documentType: "资料索引"
topics: ["论文","官方文档","证据边界"]
...
对应研究笔记：[NVIDIA Rubin GPU + Groq 3 LPX](../notes/nvidia-groq3-heterogeneous-inference.md)。
...
对应研究笔记：[Tenstorrent 架构](../notes/tenstorrent-architecture.md)与[Groq、Tensix、GPU 对照](../notes/groq-tenstorrent-comparison.md)。
...
对应研究笔记：[Google TPU 架构](../notes/google-tpu-architecture.md)与[四类加速器统一对照](../notes/ai-accelerator-architecture-comparison.md)。对应教学实验：[Systolic wavefront](../labs/systolic_array.md)。
